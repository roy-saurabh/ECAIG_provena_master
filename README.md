...
| `MANUSCRIPT_NUMBERS_TO_REVISE.md` | Auto-generated audit comparing generated numbers to manuscript claims |
...
`manuscript_tables` in the JSON contains row-level data for each table. `MANUSCRIPT_NUMBERS_TO_REVISE.md` lists every manuscript claim with its generated value and a recommended replacement sentence.
