...
def generate_manuscript_audit(results: Dict) -> str:
    ...
    Returns markdown text for GENERATED_RESULTS_AUDIT.md.
    """
    lines: List[str] = [
        "# GENERATED RESULTS AUDIT",
        "",
...
def main() -> None:
    ...
    audit_path = "GENERATED_RESULTS_AUDIT.md"
...
def _write_repo_readiness(results: Dict, out_path: str = "validation_results.json") -> None:
    ...
    lines = [
        ...
        f"{ck(True)} GENERATED_RESULTS_AUDIT.md generated",
